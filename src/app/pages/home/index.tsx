  ...
  export const component = decorate(style)(props => {
    ...
    return (
      <AppGrid container={true}>
        <AppGrid {...itemProps}>
          <AppCard>
            <AppCardHeader title="Simple CRUD" subheader="シンプルな画面デモ" />
            <AppCardMedia src={simple}>
              <Link to={Url.productsSimpleIndex}>
                <img src={simple} className={props.classes.image} />
              </Link>
            </AppCardMedia>
          </AppCard>
        </AppGrid>
          ...
          <AppCard>
            ...
            <AppCardMedia src={pane}>
              <Link to={Url.productsPaneIndex}>
                <img src={pane} className={props.classes.image} />
              </Link>
            </AppCardMedia>
          </AppCard>
        </AppGrid>
          ...
          <AppCard>
            ...
            <AppCardMedia src={window}>
              <Link to={Url.productsWindowIndex}>
                <img src={window} className={props.classes.image} />
              </Link>
            </AppCardMedia>
          </AppCard>
        </AppGrid>
        <AppGrid {...itemProps}>
          <AppCard>
            <AppCardHeader title="Settings" subheader="表示テーマの変更" />
            <AppCardMedia src={settings}>
              <Link to={Url.homeSetting}>
                <img src={settings} className={props.classes.image} />
              </Link>
            </AppCardMedia>
          </AppCard>
        </AppGrid>
