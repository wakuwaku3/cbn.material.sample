...
import { FormControlProps, FormLabelProps, FormControlLabelProps } from 'material-ui/Form';
...
export const AppButton: React.SFC<AppButtonProps> = props => <Button {...props}>{props.children}</Button>;
...
export const AppPaper: React.SFC<AppPaperProps> = props => <Paper {...props}>{props.children}</Paper>;
...
export const AppRadio: React.SFC<AppRadioProps> = props => <Radio {...props}>{props.children}</Radio>;
...
export const AppFormLabel: React.SFC<AppFormLabelProps> = props => <FormLabel {...props}>{props.children}</FormLabel>;
export interface AppFormControlLabelProps extends FormControlLabelProps {}
export const AppFormControlLabel: React.SFC<AppFormControlLabelProps> = props => (
    <FormControlLabel {...props}>{props.children}</FormControlLabel>
);
export interface AppSwitchProps extends SwitchProps {}
export const AppSwitch: React.SFC<AppSwitchProps> = props => <Switch {...props}>{props.children}</Switch>;
...
export const AppBar: React.SFC<AppBarProps> = props => <MuiAppBar {...props}>{props.children}</MuiAppBar>;
export interface AppToolbarProps extends ToolbarProps {}
export const AppToolbar: React.SFC<AppToolbarProps> = props => <Toolbar {...props}>{props.children}</Toolbar>;
export interface AppMenuProps extends MenuProps {}
export const AppMenu: React.SFC<AppMenuProps> = props => <Menu {...props}>{props.children}</Menu>;
export interface AppMenuItemProps extends MenuItemProps {}
export const AppMenuItem: React.SFC<AppMenuItemProps> = props => <MenuItem {...props}>{props.children}</MenuItem>;
